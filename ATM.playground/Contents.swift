...
// login
let passwordValue = "thanhdat2003"
// người dùng nhập vào
...
// transfer money
let amountTransferValue: Double = 600000 // người dùng nhập vào
let resultTransfer = transferMoney(amountTransferValue, myAccount, myFriendAccount)
print(resultTransfer.message)
 
 
// withdraw money
let amountWithDrawValue: Double = 600000 // người dùng nhập vào
let resultWithDraw = withDrawMoney(amountWithDrawValue, myAccount)
print(resultWithDraw.message)
 
//change password
let newPassword1 = "2003" // người dùng nhập vào
let newPassword2 = "2003" // người dùng nhập vào
